...
public class UpdateStoreAndProductInterestImplTest {
    private final String endPointUrl = "http://localhost:PORT_NUMBER/wcs/resources/store/STORE_ID/xpersonalInterest/xUpdateInterests?updateCookies=true&storeId=STORE_ID&profileName=xProductInterest&responseFormat=json";
    private MockWebServer mockWebServer;
    @Mock
    private PropertyReaderService propertyReaderService;
    @InjectMocks
    private UpdateStoreAndProductInterestImpl impl;
    ...
    @Test
    public void testUpdateInterests() throws IOException, ServiceException {
        try (InputStream is1 = getClass().getResourceAsStream("update_interest_request.json");
                InputStream is2 = getClass().getResourceAsStream("update_interest_response.json")) {
            final UpdateStoreAndProductInterestImpl.Config config = Mockito
                    .mock(UpdateStoreAndProductInterestImpl.Config.class);
            ...
            UpdateStoreAndProductInterestResponse response;
            ...
            response = impl.updateInterests(requestHeader);
