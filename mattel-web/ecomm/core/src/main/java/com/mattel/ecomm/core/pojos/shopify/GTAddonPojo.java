...
public class GTAddonPojo {
  ...
  @JsonProperty
  private List<Variant> childProducts;
  ...
  /**
   * @param kitDisplayable
   *          the kitDisplayable to set
   */
  ...
  /**
   * @param kitDisplaySequence
   *          the kitDisplaySequence to set
   */
  ...
  /**
   * @param kitInstructions
   *          the kitInstructions to set
   */
  ...
  /**
   * @param trunkDescription
   *          the trunkDescription to set
   */
   ...
   */
  public List<Variant> getChildProducts() {
   ...
   */
  public void setChildProducts(List<Variant> childProducts) {
  ...
  public String toString() {
    return "GTAddonPojo [buyable=" + buyable + ", productType=" + productType + ", associationType="
        + associationType + ", name=" + name + ", optionalName=" + optionalName + ", partNumber="
        + partNumber + ", variantId=" + variantId + ", thumbnail=" + thumbnail + ", fullimage="
        + fullimage + ", kitOption=" + kitOption + ", kitDisplayable=" + kitDisplayable
        + ", kitDisplaySequence=" + kitDisplaySequence + ", kitInstructions=" + kitInstructions
        + ", trunkDescription=" + trunkDescription + ", imageLink=" + imageLink + ", childProducts="
        + childProducts + "]";
  }
