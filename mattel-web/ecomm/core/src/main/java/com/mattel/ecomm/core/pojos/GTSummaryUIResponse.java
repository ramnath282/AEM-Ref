...
public class GTSummaryUIResponse {
  ...
  /**
   * @param seo_metaDescription the seo_metaDescription to set
   */
  ...
  /**
   * @param seo_PageTitle the seo_PageTitle to set
   */
  ...
  /**
   * @param seo_imageAltText the seo_imageAltText to set
   */
  ...
  /**
   * @param auxDescription1 the auxDescription1 to set
   */
  ...
  /**
   * @param seo_urlKeyword the seo_urlKeyword to set
   */
  ...
  /**
   * @param gtHearingAidDetails the gtHearingAidDetails to set
   */
  ...
  /**
   * @param gtEarPiercingDetails the gtEarPiercingDetails to set
   */
  ...
  /**
   * @param gtBoxDetails the gtBoxDetails to set
   */
  ...
  /**
   * @param gtEnvelopeDetails the gtEnvelopeDetails to set
   */
  ...
  /**
   * @param getLetterDetails the getLetterDetails to set
   */
  public void setGtLetterDetails(GTAddonPojo gtLetterDetails) {
	...
	/**
	 * @param gtNonDisplayableItems the gtNonDisplayableItems to set
	 */
	...
	/**
	 * @param gtDisplayableItems the gtDisplayableItems to set
	 */
