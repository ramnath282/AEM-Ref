...
public class ContactPreferencesUIResponseTest {

    private ContactPreferencesUIResponse impl = null;
    private ContactPrefSEQMapUI contactprefseqmap = new ContactPrefSEQMapUI();
