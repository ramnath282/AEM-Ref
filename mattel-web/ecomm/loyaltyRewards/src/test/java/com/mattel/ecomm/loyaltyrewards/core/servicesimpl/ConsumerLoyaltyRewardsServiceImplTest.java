...
public class ConsumerLoyaltyRewardsServiceImplTest {
  private final String endPointUrl = "http://localhost:PORT_NUMBER/wcs/resources/store/STORE_ID/xloyalty/xGetConsumerLoyaltyData?storeId=STORE_ID&responseFormat=json";

  private MockWebServer mockWebServer;

  private ConsumerLoyaltyRewardsResponse consumerLoyaltyRewardsResponse;

  @InjectMocks
  private ConsumerLoyaltyRewardsServiceImpl consumerLoyaltyRewardsServiceImpl;
  @Mock
  PropertyReaderService propertyReaderService;

  @Test
  public void testLoyaltyRewards() throws IOException, ServiceException {

    try (InputStream is1 = getClass()
        .getResourceAsStream("consumer_loyalty_rewards_response.json");) {
      final ConsumerLoyaltyRewardsServiceImpl.Config config = Mockito
          .mock(ConsumerLoyaltyRewardsServiceImpl.Config.class);
      ...
      consumerLoyaltyRewardsServiceImpl.activate(config);
      consumerLoyaltyRewardsResponse = consumerLoyaltyRewardsServiceImpl.fetch(requestMap);
      Assert.assertNotNull(consumerLoyaltyRewardsResponse);
  ...
  public void testLoyaltyRewardsWithWCSError() throws IOException, ServiceException {
    try (InputStream is1 = getClass()
      ...
      Mockito.when(propertyReaderService.getCookieDomain("AG")).thenReturn("localhost");
      consumerLoyaltyRewardsServiceImpl.activate(config);
      consumerLoyaltyRewardsServiceImpl.fetch(requestMap);
