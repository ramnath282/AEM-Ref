...
public class PDPCollectiveOfferPriceImplTest {

  @InjectMocks
  private PDPCollectiveOfferPriceImpl pDPCollectiveOfferPriceImpl;
  @Mock
  ...
  @Test
  public void testPDPCollectiveOfferPrice() throws IOException, ServiceException {
    try (
        InputStream is = getClass()
            .getResourceAsStream("get_pdp_collective_offer_price_response.json");
        InputStream is1 = getClass()
            .getResourceAsStream("pdp_collective_offer_price_request.json")) {
      final PDPCollectiveOfferPriceImpl.Config config = Mockito
          .mock(PDPCollectiveOfferPriceImpl.Config.class);
      ...
      pDPCollectiveOfferPriceImpl.activate(config);
      PDPCollectiveOfferPriceResponse pdpCollectiveOfferPriceResponse = pDPCollectiveOfferPriceImpl
          .getOfferPrice(requestMap);
      Assert.assertNotNull(pdpCollectiveOfferPriceResponse);
  ...
  public void testPDPCollectiveOfferPriceWithWCSError() throws IOException, ServiceException {
    try (InputStream is1 = getClass()
      ...
      Mockito.when(propertyReaderService.getCookieDomain("AG")).thenReturn("localhost");
      pDPCollectiveOfferPriceImpl.activate(config);
      pDPCollectiveOfferPriceImpl.getOfferPrice(requestMap);
  ...
  @Test(expected = ServiceException.class)
  public void testPDPCollectiveOfferPriceWithWCSDown() throws IOException, ServiceException {
    try (InputStream is1 = getClass()
        .getResourceAsStream("pdp_collective_offer_price_request.json")) {
      final PDPCollectiveOfferPriceImpl.Config config = Mockito
          .mock(PDPCollectiveOfferPriceImpl.Config.class);
