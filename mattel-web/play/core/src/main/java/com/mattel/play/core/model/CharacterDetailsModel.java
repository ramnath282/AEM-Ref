...
public class CharacterDetailsModel {
            ...
            if (resource != null) {
                ...
                if (pageManager != null) {
                    ...
                    if (page != null) {
                        ...
                        rootPath = rootPagePath.isEmpty() ? page.getAbsoluteParent(6).getPath() : rootPagePath;
    ...
    public String getCharacterCarouselSlidesMappings(String nodePath, String slideCount) {
        ...
        String brand = PlayHelper.getBrandName(nodePath);
        LOGGER.debug("brand value of CharacterDetailsModel is {}", brand);
        slideCount = PlayHelper.getSlideCount(slideCount, slideshowValueMapping, brand);
    ...
    public String getPrevCharacter() {
        LOGGER.debug("Get Prev Character {} ", prevCharacter);
        return prevCharacter;
    }

    public String getNextCharacter() {
        LOGGER.debug("Get Next Character {} ", nextCharacter);
    ...
    private void setPrevNextLinks(List<TilePojo> tileList, String currentPath, Resource resource) {
        ...
        if (tileList != null) {
            currentPath = PlayHelper.checkLink(currentPath, resource);
            LOGGER.debug("currentPath value of CharacterDetailsModel is {}", currentPath);
