...
public class TilePojo {
	...
	private String descLineOne;
	private String descLineTwo;
	...
	public String getDescLineOne() {
		return descLineOne;
	}

	public void setDescLineOne(String descLineOne) {
		this.descLineOne = descLineOne;
	}

	public String getDescLineTwo() {
		return descLineTwo;
	}

	public void setDescLineTwo(String descLineTwo) {
		this.descLineTwo = descLineTwo;
	}
	...
	public String toString() {
		return "TilePojo tilePageName=" + tilePageName + ", tilePath=" + tilePath + ", tileImage=" + tileImage
				+ ", tileImgAltText=" + tileImgAltText + ", descLineOne=" + descLineOne + ", descLineTwo=" + descLineTwo + ", tileCategory=" + tileCategory + ", tileTitle=" + tileTitle
