...
public class CategoryColumnPojo {
  ...
  public String toString() {
    return "CategoryColumnPojo [subCatTitle=" + subCatTitle + ", subCatLink=" + subCatLink
        + ", subCatUrlTarget=" + subCatUrlTarget + ", subCatAeText=" + subCatAeText
        + ", parentPage=" + parentPage + ", columnListFrom=" + columnListFrom + ", viewAllText="
        + viewAllText + ", viewAllLink=" + viewAllLink + ", linkTargetForViewAll="
        + linkTargetForViewAll + ", aeForViewAll=" + aeForViewAll + ", parentPageList="
        + Arrays.toString(parentPageList) + "]";
  }
