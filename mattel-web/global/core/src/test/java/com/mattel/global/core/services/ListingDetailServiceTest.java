...
import com.mattel.global.core.services.ListingDetailService.Config;

@RunWith(PowerMockRunner.class)
public class ListingDetailServiceTest {
  ...
  public void setup() throws Exception {
    ...
    listingDetailService = new ListingDetailService();
    config = Mockito.mock(ListingDetailService.Config.class);
    resolverFactory = Mockito.mock(ResourceResolverFactory.class);
    resolver = Mockito.mock(ResourceResolver.class);
    resource = Mockito.mock(Resource.class);
    when(config.cfPath()).thenReturn(cfPath);
    MemberModifier.field(ListingDetailService.class, "resolverFactory").set(listingDetailService,
        resolverFactory);
  ...
  public void testToVerifyValidContentFragment() {
    ...
    listingDetailService.activate(config);
    Assert.assertNotNull(listingDetailService.getFragmentDetails(selectors, "corp"));
  }

  @Test
  public void testToVerifyValidCategoryTags() {

    listingDetailService.activate(config);
    Assert.assertNotNull(listingDetailService.getArticleTagList(selectors, "corp"));
  }
  ...
  public void testToVerifyContentFragmentWithInvalidPath() {
    ...
    listingDetailService.activate(config);
    Assert.assertNull(listingDetailService.getFragmentDetails(selectors, "corp"));
  }
